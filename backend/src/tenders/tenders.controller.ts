...
export class TendersController {
  ...
  @Roles('GOV_ADMIN')
  createTender(@Body() body: { auctionId: string; deadline: string }) {
    return this.tenders.createTender(body.auctionId, new Date(body.deadline))
  }
  ...
  scoreProposal(
    ...
    @Body() body: { designScore: number; timelineScore: number; socialScore: number },
    @Request() req,
  ) {
